	...
	<div class="container-fluid">
		<div class="row-fluid">
			...
			<div class="col-xs-12 no-padding">
                ...
                <div class="clear"></div>
                <div id="detail-slide" class="flexslider">
                    <ul class="slides">
                    <?php foreach ($banners->result_array() as $key => $banner): ?>
                        <li >
...
<script type="text/javascript">
	$(document).ready(function () {
        ...
        $('#detail-slide').flexslider({
            animation: "slide",
            controlNav: true,
            slideshow: false,
            directionNav: true,
            smoothHeight: true,
            prevText:'<img src="<?php echo base_url('assets/imgs/previos-detail.svg') ?>"  />',
            nextText:'<img src="<?php echo base_url('assets/imgs/next-detail.svg') ?>"  />', 
            start: function(slider){
                
            },
            after: function(slider){
                $('#banner-slide').data('flexslider').flexAnimate(slider.currentSlide, true);
            } 
        });
    });
