...
function initialize() {
        ...
        bangalore = new google.maps.LatLng(<?php echo $home->google_map; ?>);
          ...
          //var mapmobile = new google.maps.Map(document.getElementById("googleMapMobile"),mapProp);
          addMarker(bangalore, map);
          //addMarker(bangalore, mapmobile);
}
...
function addMarker(location, map) {
    ...
    var marker = new google.maps.Marker({
        ...
        icon: '<?php echo base_url('assets/imgs/mark_logo_Enrich.png') ?>',
    });

    var contentString ="<h3>บริษัท เอ็นริช สเตทส์ จำกัด</h3> <div class='address'>เลขที่ 98 หมู่ 7 ถ.ปลายบาง ต.มหาสวัสดิ์ อ.บางกรวย จ.นนทบุรี 11130 <br>โทร. <a href='tel:024031000'>02 403 1000</a> แฟกซ์ 02 403 1099</div>";
